      ...
      >
        ...
        <div className="flex flex-1 items-center justify-end md:justify-between">
          ...
          <div className="flex items-center gap-4">
            {
              user ? <SignOutButton className="block rounded-md bg-red-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-red-700" /> : <div className="sm:flex sm:gap-4">
                <a
